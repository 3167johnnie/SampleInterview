...
@NamedQueries({
	...
	//Select a.CONSENT_WRITE_REQUEST from SBI_TEST.RUPEEPOWER_OCAS_T_13701 a where  a.CONSENT_WRITE_CIF_NUMBER ='00000085001389605' and a.CONSENT_WRITE_RESPONSE_CODE ='200';
		...
		@NamedQuery(name = "ConsentWriteLog.getConsentWriteLogByNtbIdAndConsentId", query = "Select a from ConsentWriteLog a where  a.ntbNumber =:ntbNumber and a.responseCode =:responseCode and a.consentId =:consentId"),
