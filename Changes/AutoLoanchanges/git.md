...
−
1
@@ -198,6 +198,20 @@ padding:4px 30px 4px 9px; font-size:15px;font-family:Roboto-Light; float:left;op	@@ -198,6 +198,20 @@ padding:4px 30px 4px 9px; font-size:15px;font-family:Roboto-Light; float:left;op
...
.form-section div.flat-field select.form-control[disabled]{background:#f8f8f8 /* url("../images/drop-down-arrow-disabled.png") no-repeat scroll 100% top !important; */}
@@ -344,7 +358,7 @@ transition:all 0.3s ease-in-out 0s, visibility 0s ease-in-out 0.3s, z-index 0s e	@@ -344,7 +358,7 @@ transition:all 0.3s ease-in-out 0s, visibility 0s ease-in-out 0.3s, z-index 0s e
...
−
0
@@ -138,7 +138,9 @@ import com.mintstreet.common.util.Constants;	@@ -138,7 +138,9 @@ import com.mintstreet.common.util.Constants;
...
import com.mintstreet.consent.entity.PrivacyRequestResponse;
@@ -310,7 +312,9 @@ public class CommonService {	@@ -310,7 +312,9 @@ public class CommonService {
...
@@ -1962,6 +1966,7 @@ public CRMNextLogDao getCrmNextLogDao() {	@@ -1962,6 +1966,7 @@ public CRMNextLogDao getCrmNextLogDao() {
	 ...
	 public boolean getLanguageBylannguageCode(String lannguageCode) throws NoResultException, SQLException {
		   ...
		   Integer count = (Integer) this.privacyNoticeDao.getLanguageBylannguageCode(lannguageCode);
@@ -1987,6 +1992,32 @@ public CRMNextLogDao getCrmNextLogDao() {	@@ -1987,6 +1992,32 @@ public CRMNextLogDao getCrmNextLogDao() {
			return application;
			return application;
	 }
	 }
...
−
1
@@ -14,7 +14,17 @@ import javax.persistence.Table;	@@ -14,7 +14,17 @@ import javax.persistence.Table;
...
−
5
@@ -21,7 +21,13 @@ import javax.persistence.Table;	@@ -21,7 +21,13 @@ import javax.persistence.Table;
@NamedQueries({
@NamedQueries({
...
public class PrivacyRequestResponse extends com.mintstreet.common.entity.Domain<Integer> implements Serializable {
@@ -184,7 +190,6 @@ public class PrivacyRequestResponse extends com.mintstreet.common.entity.Domain<	@@ -184,7 +190,6 @@ public class PrivacyRequestResponse extends com.mintstreet.common.entity.Domain<
	...
	public String toString() {
		...
		return "PrivacyRequestResponse [privacyId=" + privacyId + ", privacyTouchPointId=" + privacyTouchPointId
@@ -195,7 +200,4 @@ public class PrivacyRequestResponse extends com.mintstreet.common.entity.Domain<	@@ -195,7 +200,4 @@ public class PrivacyRequestResponse extends com.mintstreet.common.entity.Domain<
...
−
0
@@ -1298,6 +1298,17 @@ public class HomeProcessManagerImpl {	@@ -1298,6 +1298,17 @@ public class HomeProcessManagerImpl {
...
−
1
@@ -50,7 +50,7 @@ public class ApplicationFormHomeLoan extends com.mintstreet.common.entity.Domain	@@ -50,7 +50,7 @@ public class ApplicationFormHomeLoan extends com.mintstreet.common.entity.Domain
...
@@ -840,6 +840,18 @@ public class ApplicationFormHomeLoan extends com.mintstreet.common.entity.Domain	@@ -840,6 +840,18 @@ public class ApplicationFormHomeLoan extends com.mintstreet.common.entity.Domain
...
@@ -2804,5 +2816,38 @@ public class ApplicationFormHomeLoan extends com.mintstreet.common.entity.Domain	@@ -2804,5 +2816,38 @@ public class ApplicationFormHomeLoan extends com.mintstreet.common.entity.Domain
...
−
1
@@ -587,6 +587,16 @@ public class ApplicationFormHomeLoanQuote extends Domain<Integer> implements Ser	@@ -587,6 +587,16 @@ public class ApplicationFormHomeLoanQuote extends Domain<Integer> implements Ser
	@Transient
	@Transient
...
@@ -2043,5 +2053,27 @@ public class ApplicationFormHomeLoanQuote extends Domain<Integer> implements Ser	@@ -2043,5 +2053,27 @@ public class ApplicationFormHomeLoanQuote extends Domain<Integer> implements Ser
...
−
0
@@ -678,6 +678,14 @@ public class HomeLoanHelper  {	@@ -678,6 +678,14 @@ public class HomeLoanHelper  {
