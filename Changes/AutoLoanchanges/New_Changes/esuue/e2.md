...
In this line value is not language is not printing  it blank it working for ConsentPopup
...
<div id="termAndConditionHTML">
	...
	<div class="modal fade otp-box" id="consentAutoLoanNTB" tabindex="-1"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="privacy-modal-body">
					...
					<%-- <div id="consentAutoLoanNTBDiv" class="f-otp-pop-content ">
					...
					<div id="consentAutoLoanNTBDiv" class="privacy-consent-pop-content">Loading
						Privacy Notice...</div>
					<!-- ACCEPT BUTTON -->
...
<script>
				...
				.ajax({
					...
					success : function(response) {
						...
						if (json.status == "success") {
							$("#consentAutoLoanNTBDiv").html(json.privacyNotice);
							$("#consentAutoLoanNTBDiv").scrollTop(0);
							resetConsentScrollValidation();
						} else {
							$("#consentAutoLoanNTBDiv").html(
									"Privacy Notice Not Found");
						}
					},
					error : function() {
						$("#consentAutoLoanNTBDiv").html0(
	...
	$(document).on("show.bs.modal", "#consentAutoLoanNTB", function(e) {
		if (!canOpenPrivacyPopup()) {
			e.preventDefault();
			return false;
		}
	});
	$(document).on("shown.bs.modal", "#consentAutoLoanNTB", function() {
	...
	$(document).on("scroll", "#consentAutoLoanNTBDiv", function() {
		var div = $(this)[0];
	...
	function resetConsentScrollValidation() {
		...
		$("#consentAutoLoanNTBDiv").off("scroll").on("scroll", function() {
			var div = $(this)[0];
			if (div.scrollTop + div.clientHeight >= div.scrollHeight - 5) {
				$("#acceptConsentBtn").prop("disabled", false).css({
					"opacity" : "1",
		...
		var div = $("#consentAutoLoanNTBDiv")[0];
