...
@NamedQueries({
	...
	//@NamedQuery(name = "ApplicationFormPersonalLoan.getApplicationFormPersonalLoanByAppCifNumberAndMobileNo", query = "Select a from ApplicationFormPersonalLoan a where  a.appActive = 'Y' and a.appDeleted ='N' "
		//	+ " and a.appCifNumber =:appCifNumber and a.appMobileNo =:appMobileNo  "),
	@NamedQuery(name = "ApplicationFormPersonalLoan.getApplicationFormPersonalLoanByAppCifNumberAndMobileNo", query = "Select a from ApplicationFormPersonalLoan a where  a.appPrivacyConsentFlag = 'Y'  "
			+ " and a.appCifNumber =:appCifNumber and a.appCcmsConsentId is not null "),
	
	//@NamedQuery(name = "ApplicationFormPersonalLoan.getApplicationFormPersonalLoanByAppCifNumberAndMobileNoAndConsentId", query = "Select a from ApplicationFormPersonalLoan a where  a.appActive = 'Y' and a.appDeleted ='N' "
	//		+ " and a.appCifNumber =:appCifNumber and a.appMobileNo =:appMobileNo and a.appConsentId=:appConsentId  "),
	
	@NamedQuery(name = "ApplicationFormPersonalLoan.getPersonalLoanByConsentId", query = "Select a from ApplicationFormPersonalLoan a where a.appPrivacyConsentFlag = 'Y'  "
			+ " and a.appCcmsConsentId=:appCcmsConsentId  "),
...
public class ApplicationFormPersonalLoan extends com.mintstreet.common.entity.Domain<java.lang.Integer>  {
  ...
  @Column(name="APP_CIF_NUMBER")
  private String appCifNumber;
  ...
  public void setCveAppConsentRevokeYes(String cveAppConsentRevokeYes) {
	...
	public String getAppCifNumber() {
		return appCifNumber;
	}

	public void setAppCifNumber(String appCifNumber) {
		this.appCifNumber = appCifNumber;
	}
