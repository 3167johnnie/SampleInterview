...
public class PersonalProcessManagerImpl {
 ...
 //   logger.info("before OTP call>>mobile::" + mobile);
  ...
  public ApplicationFormPersonalLoan processSubmitQuote(Integer appSeqId, Integer requestIndex, ApplicationFormPersonalLoan appForm, String isDsrPage, Integer bankLMSUserId) throws SQLException, IllegalArgumentException, RuntimeException, ParseException {
    ApplicationFormPersonalLoan appFormData = this.personalLoanService.getApplicationFormPersonalLoanByAppSeqId(appSeqId);
    if (appFormData == null)
      return null; 
  ...
  public String setUtmParam(String utm) {
	...
	//new code for cibil call
	 ...
	 public ConsentReadResponse getConsentReadResponse(String cifNumber) {
		...
		private boolean writePrivacyConsentToCCMS(ApplicationFormPersonalLoan application, ApplicationFormPersonalLoanQuote quote,LoanScenarioBean loanScenarioBean, Integer loanTypeId) {
			
			logger.info("method writePrivacyConsentToCCMS called");
			...
			logger.info("CCMS consent ID saved in Quote and Application. " + "consentId: {}, quoteId: {}, appSeqId: {}, loanTypeId: {}", ccmsConsentId, quote.getLoanQuoteId(), application.getAppSeqId(), loanTypeId);
				...
				SMS_TEXT=SMS_TEXT.replaceAll("LOAN_TYPE", "PL");
