...
public class ApplicationFormPersonalLoanQuoteDao extends GenericDao<Integer,ApplicationFormPersonalLoanQuote>{
	private static final long serialVersionUID = 4471487322524090822L;
	public Integer getOldVisitId(Integer quoteId){
		List<Object> params = new LinkedList<Object>();
		String query="SELECT QUOTE_SEQUENCE_ID, QUOTE_VISIT_ID, QUOTE_NEW_VISIT_ID FROM RUPEEPOWER_OCAS_T_00440 WHERE QUOTE_SEQUENCE_ID =?";
		params.add(quoteId);
