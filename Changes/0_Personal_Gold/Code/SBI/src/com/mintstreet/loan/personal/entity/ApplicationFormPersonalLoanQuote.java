...
public class ApplicationFormPersonalLoanQuote extends com.mintstreet.common.entity.Domain<java.lang.Integer>  {
	...
	@Column(name="QUOTE_CIF_NUMBER")
	private String loanQuoteCifNumber;
	...
	public String getLoanQuoteCifNumber() {
		return loanQuoteCifNumber;
	}
	public void setLoanQuoteCifNumber(String loanQuoteCifNumber) {
		this.loanQuoteCifNumber = loanQuoteCifNumber;
	}
