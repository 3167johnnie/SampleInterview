...
public class PersonalLoanService{
	...
	public List<ApplicationFormPersonalLoan> getApplicationFormPersonalLoanByAppCifNumberAndMobileNo(String appCifNumber
			) throws SQLException, NoResultException {
		logger.info("appCifNumber " + appCifNumber );
		return this.applicationFormPersonalLoanDao.getApplicationFormPersonalLoanByAppCifNumberAndMobileNo(appCifNumber);
	}
	
	public ApplicationFormPersonalLoan getPersonalLoanByConsentId(String appConsentId) throws SQLException, NoResultException {
		logger.info("appConsentId " + appConsentId);
		return applicationFormPersonalLoanDao.getPersonalLoanByConsentId(appConsentId);
	}
