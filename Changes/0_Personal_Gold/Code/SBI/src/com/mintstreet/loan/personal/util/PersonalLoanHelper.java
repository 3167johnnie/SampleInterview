...
public class PersonalLoanHelper {
  ...
  public ApplicationFormPersonalLoanQuote getUpdateQuote(ApplicationFormPersonalLoanQuote quote) throws IllegalArgumentException, RuntimeException, ParseException  {
