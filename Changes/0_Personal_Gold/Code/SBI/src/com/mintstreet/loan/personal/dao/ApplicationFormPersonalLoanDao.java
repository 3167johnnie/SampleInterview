...
public class ApplicationFormPersonalLoanDao  extends GenericDao<Integer, ApplicationFormPersonalLoan>{
	...
	public List<ApplicationFormPersonalLoan> getApplicationFormPersonalLoanByAppCifNumberAndMobileNo(String appCifNumber) throws SQLException, NoResultException {
	    Map<String, Object> params = new HashMap<>(2);
	    params.put("appCifNumber", appCifNumber);
	   return   findByNamedQuery("ApplicationFormPersonalLoan.getApplicationFormPersonalLoanByAppCifNumberAndMobileNo", params);
	    
  }
  
  public ApplicationFormPersonalLoan getPersonalLoanByConsentId(String appConsentId) throws SQLException, NoResultException {

	  Map<String, Object> params = new HashMap<>(2);
	    params.put("appCcmsConsentId", appConsentId);
	    List<ApplicationFormPersonalLoan> list =findByNamedQuery("ApplicationFormPersonalLoan.getPersonalLoanByConsentId", params);
	   if (list.size() == 1)
		      return list.get(0); 
		    return null;    
	}
