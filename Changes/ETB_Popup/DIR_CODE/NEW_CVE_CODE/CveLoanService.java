...
public class CveLoanService {
	...
	public void setCveProductDao(MasterCveProductDao cveProductDao) {
	 ...
	 public ApplicationFormCveLoan save(ApplicationFormCveLoan applicationFormCveLoan) throws SQLException {
	      applicationFormCveLoan.setAppLeadUpdateTime(new Date());
		  
	      return applicationFormCveLoanDao.save(applicationFormCveLoan.getAppSeqId(), applicationFormCveLoan);
	  }
