			...
			<div class="clearfix"></div>
				...
				<!-- 	<input type="checkbox" class="blue-css-checkbox" name="infoprovideCve" id="infoprovideCve" value="on" disabled="disabled">
					<label for="infoprovideCve" class="label-content" style="font-size:14px; ">
						...
						<s:if
							test="%{appForm.appMobileVerified!=null && appForm.appMobileVerified.equalsIgnoreCase('Y')}">
				...
				<div class="trms-section">
					...
					<!-- <label for="infoprovide" class="label-content" style="font-size:14px; ">
						...
						<b><a href="javascript:void(0);" onclick="javascript:openPopups('consentCveLoan','1');"> SBI’s Privacy Notice </a></b><b class="req">*</b>
								...
								<label for="infoprovide" id="consentLabel" class="label-content"
									style="font-size: 14px;"> I hereby authorize State Bank
									of India and/or its representative to contact me with reference
									to my application. For more details please read <b> <a
										href="javascript:void(0);" id="privacyNoticeLink"
										onclick="javascript:openPopups('consentCveLoan','1');">
											SBI’s Privacy Notice </a>
								</b> <b class="req">*</b>
								</label>
...
<div id="termsAndConditionCBS" class="sbi-trms-div sbi-trms-div-cbs" style="display :<s:property value="%{showCBS?'block':'none'}"/>;">
				<ul class="form-section">
					<li class="full-width">
						...
						<div class="qt-btn-div trms-btn flr mrgt-10">
							<input  type="submit" class="submit-btn" value="Submit" id="submitBtnRevoke">
						</div>
					</li>
				</ul>
			</div>
