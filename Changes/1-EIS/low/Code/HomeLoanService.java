...
public class HomeLoanService {
  ...
  //ccms 
  /*public ApplicationFormHomeLoan getApplicationFormHomeLoanByAppCifNumberAndMobileNo(String appCifNumber, String appMobileNo) throws SQLException, NoResultException {
	  logger.info("appCifNumber "+appCifNumber+"appMobileNo  "+appMobileNo);
	    ApplicationFormHomeLoan application = this.applicationFormHomeLoanDao.getApplicationFormHomeLoanByAppCifNumberAndMobileNo(appCifNumber, appMobileNo);
	...
	public List<ApplicationFormHomeLoan> getApplicationFormHomeLoanByAppCifNumber(String appCifNumber) throws SQLException, NoResultException {
		logger.info("appCifNumber " + appCifNumber);
		return this.applicationFormHomeLoanDao.getApplicationFormHomeLoanByAppCifNumber(appCifNumber);

	}

	public ApplicationFormHomeLoan getApplicationFormHomeLoanByAppCifNumberAndMobileNoAndConsentId(String appCifNumber, String appConsentId) throws SQLException, NoResultException {
		logger.info("appCifNumber " + appCifNumber +"appConsentId " + appConsentId);
		return applicationFormHomeLoanDao.getHomeLoanByCifMobileAndConsentId(appCifNumber, appConsentId);
	}
