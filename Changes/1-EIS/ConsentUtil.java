...
public class ConsentUtil {
	...
	public void callCCMSConsentWriteAPI(ConsentRequestDpData dpData, List<ConsentRequestConsent> consents) {
		try {
//		// generate plain request
			ConsentWriteLog consentWrite = consentService.generateConsentWriteRequest(dpData, consents);
			// send request and read purpose from CCMS
			consentService.writeConsentToCCMS(consentWrite);
		} catch (JSONException e) {
			e.printStackTrace();// TODO add loggers
