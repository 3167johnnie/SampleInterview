...
@Entity
@Table(name="RUPEEPOWER_OCAS_T_00080")
@org.hibernate.annotations.Entity(dynamicUpdate = true, dynamicInsert = true)
@SequenceGenerator(name="G13", sequenceName="RUPEEPOWER_OCAS_SEQ_00008" ,allocationSize=1)
public class ApplicationFormAutoLoanCalls extends Domain<Integer> implements Serializable {
	private static final long serialVersionUID = -3431561045158949121L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="G13")
	@Column(name="CALL_ID")
	...
	public ApplicationFormAutoLoanCalls() {
	}
