...
@Entity
@Table(name="RUPEEPOWER_OCAS_T_00399")
@org.hibernate.annotations.Entity(dynamicUpdate = true, dynamicInsert = true)
@SequenceGenerator(name="G14", sequenceName="RUPEEPOWER_OCAS_SEQ_00224" ,allocationSize=1)
public class ApplicationFormPersonalLoanCalls extends Domain<Integer> implements Serializable {
	private static final long serialVersionUID = -3431561045158949121L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="G14")
	@Column(name="CALL_ID")
	...
	public ApplicationFormPersonalLoanCalls() {
	}
