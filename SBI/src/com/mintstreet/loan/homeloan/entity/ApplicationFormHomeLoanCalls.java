...
@Entity
@Table(name="RUPEEPOWER_OCAS_T_00224")
@org.hibernate.annotations.Entity(dynamicUpdate = true, dynamicInsert = true)
@SequenceGenerator(name="G10", sequenceName="RUPEEPOWER_OCAS_SEQ_00080" ,allocationSize=1)
public class ApplicationFormHomeLoanCalls extends Domain<Integer> implements Serializable {
	private static final long serialVersionUID = -3431561045158949121L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="G10")
	@Column(name="CALL_ID")
	...
	public ApplicationFormHomeLoanCalls() {
	}
