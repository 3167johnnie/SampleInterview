...
public class ApplicationFormHomeLoanQuoteDao extends GenericDao<Integer,ApplicationFormHomeLoanQuote>{
	private static final long serialVersionUID = -1006914800077518063L;
	public Integer getOldVisitId(Integer quoteId){
        List<Object> params = new LinkedList<Object>();
		String query="SELECT QUOTE_SEQUENCE_ID, QUOTE_VISIT_ID, QUOTE_NEW_VISIT_ID FROM RUPEEPOWER_OCAS_T_00255 WHERE QUOTE_SEQUENCE_ID =?";
		params.add(quoteId);
