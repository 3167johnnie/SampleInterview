...
import com.mintstreet.loan.card.entity.ApplicationFormCreditCardQuote;
	...
	public static JSONObject getJONObjctFromJSONString(String jsonString){
	  ...
	  public static Object getObjctFromJSON(Object object, String jsonInString) {
		  ...
		  if(object instanceof OtherRequest){
			  ...
			  objectFromJSONToBean= gson.fromJson(jsonInString, ApplicationFormCreditCard.class);  
		  }else if(object instanceof ApplicationFormCreditCardQuote){
			  objectFromJSONToBean= gson.fromJson(jsonInString, ApplicationFormCreditCardQuote.class);  
		  }else if(object instanceof ApplicationFormLead ){
		  ...
		  /*else if(object instanceof MobileDeviceInformation){
			  ...
			  objectFromJSONToBean= gson.fromJson(jsonInString, CardScenario.class);
		  }
		  /*else if(object instanceof MingleBean){
			  objectFromJSONToBean= gson.fromJson(jsonInString, MingleBean.class);
		  }*/
