...
<s:include value="/appNew/loan/educationloan/EducationLeftSidebar.jsp"></s:include>
<s:include value="/appNew/loan/educationloan/EducationRightContent.jsp"></s:include>
<%-- <s:if test="%{educationLoanPage == 1}">
