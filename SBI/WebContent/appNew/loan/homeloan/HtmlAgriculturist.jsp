...
<li id="divnetAnnualIncome">
	...
	<s:textfield name="quote.loanQuoteNetAnnualIncome" id="netAnnualIncome" value="%{quote.loanQuoteNetAnnualIncome>0?quote.loanQuoteNetAnnualIncome:''}" cssClass="form-control" autocomplete="off" maxlength="9" placeholder="Rs" onkeydown="return M.digit(event);" onblur="var tm=M.formatAsMoneyStr(this.value);this.value=tm?tm:'';" onfocus="this.value=M.unformatMoney(this.value);"/>
</li>
<div id="expectedMonthlyAgri">
...
<s:if test="%{#needToDisplay==false}">
	<li id="divpreEMIsOther">
		<label class="">Existing EMIs, if any other bank (<span class="font-rupee">`</span>)<b class="req"></b></label>
