<%@ taglib prefix="s" uri="/struts-tags"%>
 <div class="add-co-applicant-box">
	<input id="coAppImageQuote" class="blue-css-checkbox" name="coAppImageQuote" type="checkbox" value="" />
		...
		<s:hidden name="csrfTokenVal" id="csrfTokenVal" value="%{#session.csrfTokenVal}" />
			...
			<ul class="form-section" >
				...
				<li id="divco_date_of_birth1">
					...
					<input type="text" name="quote.loanQuoteCoapplicantFirstDateOfBirth" id="co_date_of_birth1" placeholder="dd-mm-yyyy"  class="form-control dob-cal" maxlength="10" value="<s:property value="%{quote.loanQuoteCoapplicantFirstDateOfBirth}"/>"  autocomplete="off"  onclick="setCalendarPlacing('divco_date_of_birth1')"/>
				</li>
				...
				<div id="EMPTYPECOAPP">
					...
					<li class="qt-btn-div flr mrgt-10 m-100">
						<input type="submit" name="saveCoApplicantQuote" id="saveCoApplicantQuote" class="submit-btn" value="Get Loan Quote">
