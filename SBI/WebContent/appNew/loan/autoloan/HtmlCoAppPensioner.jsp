...
<li id="divco_netMonthlyPension1">
	<label class="">Net monthly pension (<span class="font-rupee">`</span>)<b class="req">*</b></label><br>
...
<s:if test="%{quote.loanQuoteCoapplicantFirstEmploymentTypeId==2}">
	<%-- <s:include value="/appNew/loan/autoloan/includes/WorkExResident1CO2.jsp"></s:include> --%>
</s:if>
</div>
