		...
		<div class="form-container-section">
   			<s:if test="%{autoLoanPage == 1}">
   				<div id="content-1" class="form-div">
					...
					<form name="autoloanform" id="autoloanform" method="post" action="javascript:void(0);" enctype="application/x-www-form-urlencoded" 
	 					onsubmit="return submit_first_page_bind();" style="display :<s:property value="%{showForm?'block':'none'}"/>;">
   			...
   			<s:elseif test="%{autoLoanPage == 2}">
   				<div id="content-2" class="form-div">
					<s:include value="/appNew/loan/autoloan/AutoSecondPage.jsp"></s:include>
				</div>
   			</s:elseif>
   			<s:elseif test="%{autoLoanPage == 3}">
	   				<div id="content-3" class="form-div">
						<s:include value="/appNew/loan/autoloan/AutoThirdPage.jsp"></s:include>
					</div>
   			</s:elseif>
   			<s:elseif test="%{autoLoanPage == 4}">
