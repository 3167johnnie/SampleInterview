		...
		<div id="test1">
			...
			<li>
				...
				<div class="flat-field">
				 ...
				 <%-- <s:select list="#{'CVECC':'Credit Card','CVELI':'Life Insurance','CVEGI':'General Insurance','CVEMF':'Mutual Funds','CVEDMAT':'Demat','CVENPS':'National Pension System (NPS)'}" name="cbs.cveProductCategory" id="cveProductCategory" headerKey="0" headerValue="Select type of Product Category" cssClass="form-control" onfocus="customOnFocus(this);" value="%{cveForm.productCategory}"/> --%>
